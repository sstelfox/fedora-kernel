...
#
# This file contains the default subsys/subdirs to prune from all
# architectures.  If an architecture needs to differ, we source a per-arch
# filter-<arch>.sh file that contains the set of override lists to be used
# instead.  If a module or subsys should be in kernel-modules on all arches,
# please change the defaults listed here.
